...
import com.isoft.eventbusmodule.android.AndroidLogger;
import com.isoft.eventbusmodule.meta.SubscriberInfoIndex;
...
public class EventBusBuilder {
    ...
    MainThreadSupport getMainThreadSupport() {
        if (mainThreadSupport != null) {
            ...
            return looperOrNull == null ? null :
                    new MainThreadSupport.AndroidHandlerMainThreadSupport((EventRunner) looperOrNull);
        } else {
            return null;
        }
    }
    ...
    static Object getAndroidMainLooperOrNull() {
        try {
            return EventRunner.getMainEventRunner();

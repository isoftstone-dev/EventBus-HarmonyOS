...
package com.isoft.eventbusmodule.util;
...
public class ErrorDialogConfig {
    ...
    public ErrorDialogConfig(Resource resources, int defaultTitleId, int defaultMsgId) {
...
//            Log.d(EventBus.TAG, "No specific message ressource ID found for " + throwable);
            HiLog.debug(new HiLogLabel(HiLog.DEBUG,01*00101,EventBus.TAG),EventBus.TAG,"No specific message ressource ID found for " + throwable);
